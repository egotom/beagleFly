...
2、目录结构
   lib  /Auto navigation 导航代码，方向角导航，最大弧线导航...,各种牛逼的导航算法。/mavlink 遥控器通讯协议。/wiringPi ,/WiringPi-Node raspberry Pi GPIO 的操作库。/PID 包含了自动驾驶要用的PID算法，和PID自整定算法。基本都是我从Arduino的C语言代码移植到node.js代码。
